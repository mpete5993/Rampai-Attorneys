          	...
          	<div class="row">
          		<div class="col-lg-12">
          			<div class="add-new-item-header">
          				<span><i class="fa fa-list text-success"></i> <a href=" {{ url('posts')}} "> View All Posts</a></span>
          			</div>
          		</div>
          	</div>
            <div class="row">
              <div class="col-lg-12">
                <div class="block">
                  <div class="title"><strong class="d-block">
                    <i class="fa fa-plus-square"></i>  Add New Post </strong>
                  </div>
                  <div class="block-body">
                    <form>
                      ...
                      <div class="form-group row">
                        <div class="col-sm-9">
                           <label class="form-control-label">Tags</label><br>
