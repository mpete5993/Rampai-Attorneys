          	...
          	<div class="row">
          		<div class="col-lg-12">
          			<div class="add-new-item-header">
          				<span><i class="fa fa-plus-circle"></i> Add New Tags</span>
          			</div>
          		</div>
          	</div>
            <div class="row">
            	<div class="col-lg-12">                           
                <div class="block">
                  <div class="title"><strong>Add Tag</strong></div>
              ...
              <div class="col-lg-12">
                <div class="block">
                  <div class="title"><strong> <i class="fa fa-tags"></i>  Tags:</strong></div>
