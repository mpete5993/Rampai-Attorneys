...
<ul class="list-unstyled">
    ...
    <li class=""><a href="{{ route('admin.roles.index') }}"> <i class="fa fa-lock" aria-hidden="true"></i> Roles </a>
    </li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="add-new-item-header">
                        <span><i class="fa fa-list text-success"></i> <a href=" {{ url('practice-areas') }} "> View All
