        ...
        <nav class="navbar navbar-expand-lg">
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between">
                ...
                <div class="right-menu list-inline no-margin-bottom">
                    ...
                    <div class="list-inline-item dropdown"><a id="languages" rel="nofollow" data-target="#"
                        ...
                        <div aria-labelledby="languages" class="dropdown-menu"><a rel="nofollow" href="#"
                                class="dropdown-item"> <img src="  {{ asset('img/flags/16/DE.png') }}" alt="English"
                                    class="mr-2"><span>German</span></a><a rel="nofollow" href="#"
                                class="dropdown-item"> <img src="  {{ asset('img/flags/16/FR.png') }}" alt="English"
                ...
                this.closest('form').submit();"
                                ...
                                {{ __('Log Out') }} <i class="icon-logout"></i></a>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <nav id="sidebar">
            ...
            <div class="sidebar-header d-flex align-items-center">
                ...
                <div class="title">
                    ...
                    <p> <button class="active-status"><i class="fa fa-circle text-success"></i></button> online</p>
                </div>
            </div>
