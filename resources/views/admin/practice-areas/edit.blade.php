                ...
                <div class="col-lg-12">
                    <div class="block">
                        <div class="title"><strong class="d-block">
                                <i class="fa fa-edit"></i> Edit Practice Area </strong>
                        </div>
                        @error('name')
                        ...
                        <div class="block-body">
                            <form method="POST" action=" {{ route('admin.practice-areas.update', $practice_area) }} "
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" placeholder="Title" class="form-control"
                                        autocomplete="off" value="{{ $practice_area->name }} ">
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label">Image</label><br>
                                    <img src=" {{ asset($practice_area->image) }} " alt="{{ $practice_area->name }}"
                                        style="margin: 5px 0px ">
                                    <input type="file" name="image" placeholder="" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label">Description</label>
                                    <textarea class="ckeditor form-control" name="description" value="">
