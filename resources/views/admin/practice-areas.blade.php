...
<div class="page-content">
        ...
        <section class="no-padding-top">
          <div class="container-fluid">
          	<div class="row">
          		<div class="col-lg-12">
          			<div class="add-new-item-header">
          				<span><i class="fa fa-plus-circle text-success"></i> <a href=" {{ url('add-new-practice-area')}} "> Add new practice area</a></span>
          			</div>
          		</div>
          	</div>
          	<div class="row">
              <div class="col-lg-12">
                <div class="block">
                  <div class="title"><strong><i class="fa fa-gavel" aria-hidden="true"></i> Practice Areas</strong></div>
